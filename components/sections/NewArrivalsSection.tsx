...
import { Heart, Star, Loader2, ChevronRight, Sparkles, Plus, Check } from "lucide-react";
...
function NewArrivalCard({ product }: { product: Product }) {
  ...
  const price = isB2B ? Number(product.priceB2B) || 0 : Number(product.priceB2C) || 0;
  ...
  return (
    ...
    >
      <div className="stb-card-tile">
        {/* "New" marker replaces the discount chip on this rail */}
        <span className="stb-chip-deal bg-stb-info">NEW</span>
...
export default function NewArrivalsSection({
  ...
  return (
    <section className="bg-stb-tint-blue py-4 md:py-6">
      <div className="mx-auto max-w-7xl px-3 md:px-4">
        <div className="mb-3 flex items-center justify-between gap-2 md:mb-4">
          <div className="flex min-w-0 items-center gap-2">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-stb-info">
